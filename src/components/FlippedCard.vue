  ...
  <div class="card-container" @click="toggleFlip">
    <div class="card" :class="{ flipped: isFlipped }">
      ...
      <div class="card-face card-front">
        <slot name="front">Front Content</slot>   <!-- Hier wird der Inhalt der Vorderseite der Karte angezeigt -->
      </div>
      <!-- Rückseite der Karte -->
      <div class="card-face card-back">
        <slot name="back">Back Content</slot>   <!-- Hier wird der Inhalt der Rückseite der Karte angezeigt -->
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {            //variablen die in der Komponente verwendet werden
    return {
      isFlipped: false
    };
  },
